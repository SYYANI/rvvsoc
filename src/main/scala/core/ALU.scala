...
object ALU {
    def ALU_OP_X      = 0.U(5.W)
    def ALU_OP_ADD    = 0.U(5.W)
    def ALU_OP_AND    = 2.U(5.W)
    def ALU_OP_OR     = 3.U(5.W)
    def ALU_OP_SL     = 4.U(5.W)
    def ALU_OP_XOR    = 5.U(5.W)
    def ALU_OP_SRL    = 6.U(5.W)
    def ALU_OP_SRA    = 7.U(5.W)
    def ALU_OP_SEQ    = 8.U(5.W)
    def ALU_OP_SNE    = 9.U(5.W)
    def ALU_OP_SLT    = 10.U(5.W)
    def ALU_OP_SGE    = 11.U(5.W)
    def ALU_OP_SLTU   = 12.U(5.W)
    def ALU_OP_SGEU   = 13.U(5.W)
    def ALU_OP_ALS    = 14.U(5.W)
    def ALU_OP_SUB    = 15.U(5.W)
    def ALU_OP_VML    = 16.U(5.W)
    def ALU_OP_VAD    = 17.U(5.W)
    ...
    def needSub(fn: UInt) = fn(3) && (fn =/= ALU_OP_ALS)
}
...
class ALU extends Module {
    ...
    val out = Mux(io.fn === ALU_OP_ADD || io.fn === ALU_OP_ALS || io.fn === ALU_OP_SUB, add_result, shift_logic)
