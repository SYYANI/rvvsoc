...
object Decoder {
    ...
    val table = Array(
        ...
        VLE->        List(Y,N,A1_RS1, A2_ZERO,IMM_I,ALU_OP_ALS, N,N,Y,MOP_RD,MEM_W, Y,WB_X,  CSR.N,Y,N,N,N,N,N,AMO_X),
        VSE->        List(Y,Y,A1_RS1, A2_ZERO,IMM_I,ALU_OP_ALS, N,N,Y,MOP_WR,MEM_W, N,WB_X,  CSR.N,Y,N,N,N,N,N,AMO_X),
        VMULVV ->    List(N,N,A1_X,   A2_X,   IMM_X,ALU_OP_VML, N,N,N,MOP_X, MEM_X, Y,WB_X,  CSR.N,Y,N,N,N,N,N,AMO_X),
        VADDVV ->    List(N,N,A1_X,   A2_X,   IMM_X,ALU_OP_VAD, N,N,N,MOP_X, MEM_X, Y,WB_X,  CSR.N,Y,N,N,N,N,N,AMO_X),
